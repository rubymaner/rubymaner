...
<html lang="en-us">
    <head>
    	<title>RM Designer & Developer</title>
        ...
        <div class="content-block" id="header">
            <div id="overlay-1">
                <header id="site-header" class="clearfix">
                    <div class="pull-left">
                        <h1><a href="#">RM Designer & Developer</a></h1>
                    </div>
                ...
                <div class="middle text-center clearfix">
                    <div class="container">
                        <h1 class="pro-name">RM Web <!-- <span style="color: #71b644;" > -->Designer & Developer<!-- </span> --></h1>
            ...
            <div class="isotope portfolio-items">
                <div class="element-item grid">
                    <div class="effect-zoe">
                        ...
                        <figcaption>
                            <h2 class="hidden-xs">Creative <span></span></h2>
                            <p class="icon-links">
       ...
       <!--  <div class="content-block text-center" id="services">
                            ...
                            <div class="container">
                                ...
                                <div class="row ">
                                    <div class="col-sm-4">
                                        ...
                                        <h2 class="proj-name count1 count-timer" >1</h2>
                                    </div>
                                    <div class="col-sm-4">
                                        <h4 class="pro-stat">Working Project</h4>
                                        <h2 class="proj-name count2">3</h2>
                                    </div>
                                    <div class="col-sm-4">
                                        <h4 class="pro-stat">Top Rated Project</h4>
                                        <h2 class="proj-name count3">2</h2>
                                    </div>
                                </div>
                                    </div>
                                </div>
                    ...
                    <div class="container-fluid">
                        ...
                        <ul class="numbersList">
                            <li class="col-md-2 col-sm-4 col-xs-6">
                                <h4> Complete B.C.A. </h4>
                                <span id="number1" class="count1 count-timer">54%</span>
                            </li>
                            <li class="col-md-2 col-sm-4 col-xs-6">
                                <h4> Complete H.S.C.</h4>
                                <span id="number2" class="count2">60.66%</span>
                            </li>
                            <li class="col-md-2 col-sm-4 col-xs-6">
                                <h4> Complete S.S.C.</h4>
                                <span id="number3"  class="count3">62.66%</span>
                            </li>
                            <li class="col-md-2 col-sm-4 col-xs-6">
                                <h4> Work On Project</h4>
                                <span id="number4" class="count4">03</span>
                            </li>
                            <li class="col-md-2 col-sm-4 col-xs-6">
                                <h4> Complete Project</h4>
                                <span id="number5" class="count5">1</span>
                            </li>
                        	...
                        	<div class="owl-carousel">
								<div class="owl-item">
									<div class="testimonial">
                                        <img alt="Client Photo" src="img/R61.jpg">
                                        <p> Strategic Planning.</p>
                                    </div>
								</div>	<!-- owl-item -->
								<div class="owl-item">
									<div class="testimonial">
                                        <img alt="Client Photo" src="img/R71.jpg">
                                        <p>Quick Lerner and Time management.</p>
                                        <br>
                                    </div>
								</div>	<!-- owl-item -->
								<div class="owl-item">
									<div class="testimonial">
                                        <img alt="Client Photo" src="img/R21.jpg">
                                        <p>Strength in problem solving and Decision making.</p>
                                    ...
                                    <div class="col-md-12">
                                        <div class="contact-info">
                                            <div class="clearfix">
                                                ...
                                                <p><strong> Address:</strong> Mumbai, 421501.
                                                </p>
                                            </div>
                                            <div class="clearfix">
                                                <div class="rotated-icon">
                                                ...
                                                <p><strong> Cell No:</strong> 9552221829</p>
                                            </div>
                                            <div class="clearfix">
                                                <div class="rotated-icon">
                                                    <div class="sqaure-nebir"></div>
                                                ...
                                                <p>
                                                    <strong> Email:</strong> rubina.m.maner@gmail.com
                                                </p>
                                            </div>
                                        </div>
                                    </div>
        ...
        <footer id="site-footer">
            <div class="container">
                <div class="row">
                    <div class="col-sm-6">
                        <div class="copyright">2020, RM Desiner & Devloper</div>
                    </div>
                    <div class="col-sm-6">
                        <div class="designed-by">Designed By <a href="http://themewagon.com/" target="_blank">Rubina Maner</a></div>
                    </div>
                </div>
            </div>
        </footer>	<!-- site-footer -->
